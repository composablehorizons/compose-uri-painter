...
val LibraryName = "Composables Core"
val LibraryDescription = "Unstyled, fully accesible Compose Multiplatform components that you can customize to your heart's desire."
val publishGroupId = "com.composables"
val publishArtifactId = "library"
